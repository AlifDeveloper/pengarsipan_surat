...
<div id="add-data-modal" class="hidden fixed inset-0 flex items-center justify-center z-50">
    <div class="relative w-[400px] max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <!-- Body Modal -->
        <form action="<?php echo e(route('klasifikasi-arsip.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\klasifikasiArsip\create.blade.php ENDPATH**/ ?>