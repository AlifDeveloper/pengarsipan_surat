    ...
    <div class="flex items-center space-x-4 relative">
        <div class="relative mr-6">
            ...
            <div id="dropdown-menu" class="absolute right-0 mt-2 w-48 bg-white rounded-md border-gray-200 border-lg border shadow-lg py-1 hidden z-50">
                <a href="<?php echo e(auth()->user()->level_user == 'kades' ? route('profile-info.index') : route('profile.index')); ?>" 
...
<?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\components\layouts\header.blade.php ENDPATH**/ ?>