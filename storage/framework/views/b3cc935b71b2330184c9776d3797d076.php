...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Search Section -->
    <form action="<?php echo e(auth()->user()->level_user == 'kades' ? route('pengarsipan-disposisi.index') : route('disposisi.index')); ?>" method="GET">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-4">
        ...
        <div class="overflow-x-auto">
            <div class="border rounded-lg border-slate-50 overflow-hidden">
                <table class="min-w-full text-left table-auto  text-xs ">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $disposisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50">
                                <td class="p-2 border border-slate-200 text-center">
                                    <p class="block  text-slate-800">
                                        <?php echo e(($disposisi->currentPage() - 1) * $disposisi->perPage() + $loop->iteration); ?>

                                    </p>
                                </td>
                                <td class="p-2 border border-slate-200">
                                    <p class="block  text-slate-800">
                                        <?php echo e($item->tgl_diterima); ?>
                                ...
                                <td class="p-2 border border-slate-200">
                                    <p
                                        ...
                                        <?php echo e($item->sifat_arsip->nama_sifat == 'Segera' ? 'bg-sgr' : ''); ?>

                                        <?php echo e($item->sifat_arsip->nama_sifat == 'Sangat Segera' ? 'bg-ss' : ''); ?>

                                        <?php echo e($item->sifat_arsip->nama_sifat == 'Rahasia' ? 'bg-rs' : ''); ?>

                                        rounded-lg text-primary">
                                        <?php echo e($item->sifat_arsip->nama_sifat); ?>
                                ...
                                <td class="p-2 border text-center border-slate-200">
                                    <p class="block text-center text-slate-800">
                                        ...
                                        <a href="<?php echo e(auth()->user()->level_user == 'kades' ? route('pengarsipan.disposisi.cetak', $item->no_disposisi) : route('disposisi.cetak', $item->no_disposisi)); ?>"
        ...
        <div class="flex justify-between items-center mt-4 text-blue">
            <a href="<?php echo e($disposisi->previousPageUrl()); ?>"
                class="flex items-center justify-center rounded-md border border-blue py-2 px-3 text-center text-xs transition-all shadow-sm hover:shadow-lg hover:text-white hover:bg-blue hover:border-blue <?php echo e($disposisi->onFirstPage() ? 'opacity-50 cursor-not-allowed' : ''); ?>">
            ...
            <div class="flex space-x-2">
                <div class="flex space-x-2">
                    <?php for($i = 1; $i <= $disposisi->lastPage(); $i++): ?>
                        <a href="<?php echo e($disposisi->url($i)); ?>"
                        ...
                        <?php echo e($disposisi->currentPage() == $i ? 'bg-blue text-white' : 'border border-slate-300'); ?>">
                            <?php echo e($i); ?>
            ...
            <a href="<?php echo e($disposisi->nextPageUrl()); ?>"
                ...
                <?php echo e($disposisi->hasMorePages() ? '' : 'opacity-50 cursor-not-allowed'); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function resetForm() {
            ...
            window.location.href = '<?php echo e(auth()->user()->level_user == 'kades' ? route('pengarsipan-disposisi.index') : route('disposisi.index')); ?>';
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\disposisi\index.blade.php ENDPATH**/ ?>