...
<div id="logout-modal" tabindex="-1" class="hidden fixed inset-0 z-50 flex items-center justify-center w-full h-screen">
    <div class="relative p-4 w-full max-w-md bg-white rounded-lg shadow-sm">
        <div class="p-4 md:p-5 text-center">
            <img src="<?php echo e(asset('svg/logout.svg')); ?>" alt="" class="mx-auto mb-4 text-gray-400 w-35 h-35">
...
<?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\components\modal\modal_logout.blade.php ENDPATH**/ ?>