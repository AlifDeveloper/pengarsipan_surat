        ...
        <div class="p-4">
            <div class="block overflow-visible">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <h3 class="text-md font-bold text-slate-800">Form Tambah Arsip Surat Masuk</h3>
                        <p class="text-slate-500 text-sm">Anda dapat menambah data surat masuk pada form dibawah ini.</p>
                    </div>
                </div>
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="<?php echo e(route('surat-masuk.store')); ?>" method="POST"
                            ...
                            <select name="kode_arsip" id=""
                                ...
                                <?php $__currentLoopData = $klasifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->kode_arsip); ?>">[<?php echo e($item->kode_arsip); ?>] <?php echo e($item->nama_arsip); ?></option>
                            ...
                            <label class="flex items-center mt-4 ml-4">
                                <input type="checkbox" id="toggleDisposisi" class="mr-2">
                                <span class="text-sm text-gray-600">Tambahkan ke Disposisi</span>
                            </label>

                            <div id="disposisiForm" class="hidden mt-4">
                                
                                <label class="block mb-1 text-sm text-slate-600 mt-4">
                                    Tanggal Keluar Surat
                                </label>
                                <input type="date" name="tgl_surat_keluar"
                                    class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                                    placeholder="DD/MM/YY" />
                                ...
                                <div class="flex">
                                    <div class="w-full md:w-6/12 mr-4">
                                        ...
                                        <input type="text" name="diteruskan"
                                            class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-20 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function previewFile(event) {
            ...
            var previewContainer = document.getElementById('dropzone-preview');
...
<script>
    document.getElementById('toggleDisposisi').addEventListener('change', function() {
        var disposisiForm = document.getElementById('disposisiForm');
        if (this.checked) {
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\suratMasuk\create.blade.php ENDPATH**/ ?>