...
<?php $__env->startSection('content'); ?>
    <div class="bg-transparent rounded-lg mb-4">
        <h2 class="text-[26px] font-bold">Edit Arsip surat Keluar</h2>
        <p class="text-gray-500 text-sm"><span class='text-blue'>Pengarsipan</span> / <span class='text-blue'>Surat
                Keluar</span> / Edit arsip keluar</p>
    </div>
        ...
        <div class="p-4">
            <div class="block overflow-visible">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <h3 class="text-md font-bold text-slate-800">Form Edit Arsip Surat Keluar</h3>
                        <p class="text-slate-500 text-sm">Anda dapat edit data surat keluar pada form dibawah ini.</p>
                    </div>
                </div>
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="<?php echo e(route('surat-keluar.update', $suratKeluar->no_suratkeluar)); ?>" method="POST"
                            ...
                            <select name="kode_arsip" id=""
                                ...
                                <?php $__currentLoopData = $klasifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->kode_arsip); ?>" <?php echo e($suratKeluar->kode_arsip == $item->kode_arsip ? 'selected' : ''); ?>>[<?php echo e($item->kode_arsip); ?>] <?php echo e($item->nama_arsip); ?></option>
                            ...
                            <div class="flex">
                                <div class="w-full md:w-6/12 mr-4">
                                    ...
                                    <input type="date" name="tgl_surat" value="<?php echo e($suratKeluar->tgl_surat); ?>"
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="no_suratkeluar" value="<?php echo e($suratKeluar->no_suratkeluar); ?>"
                            ...
                            <div class="flex">
                                <div class="w-full md:w-6/12 mr-4">
                                    ...
                                    <input type="text" name="perihal" value="<?php echo e($suratKeluar->perihal); ?>"
                                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-20 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="tujuan" value="<?php echo e($suratKeluar->tujuan); ?>"
                                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                            ...
                            <select name="nip" id=""
                                ...
                                <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->nip); ?>" <?php echo e($suratKeluar->nip == $item->nip ? 'selected' : ''); ?>><?php echo e($item->jabatan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\suratKeluar\edit.blade.php ENDPATH**/ ?>