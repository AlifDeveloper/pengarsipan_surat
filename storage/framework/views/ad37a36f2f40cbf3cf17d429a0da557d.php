...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Search Section -->
    <form action=<?php echo e(route('klasifikasi-arsip.index')); ?> method="GET">
        <div class="bg-white p-6 rounded-lg shadow-md mt-4">
            ...
            <div class="flex">
                <div class="w-full md:w-4/12 mr-4">
                    ...
                    <input type="text" name="search_kode" value="<?php echo e(request('search_kode')); ?>"
                ...
                <div class="w-full md:w-5/12">
                    ...
                    <input type="text" name="search_nama" value="<?php echo e(request('search_nama')); ?>"
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-4">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="p-4 border border-slate-200 text-center">
                                <p class="block  text-slate-800">
                                    <?php echo e(($arsip->currentPage() - 1) * $arsip->perPage() + $loop->iteration); ?>

                                </p>
                            </td>
                            <td class="p-4 border border-slate-200">
                                <p class="block  text-slate-800">
                                    <?php echo e($item->kode_arsip); ?>

                                </p>
                            </td>
                            <td class="p-4 border border-slate-200">
                                <p class="block  text-slate-800">
                                    <?php echo e($item->nama_arsip); ?>
        ...
        <div class="flex justify-between items-center mt-4 text-blue">
            <a href="<?php echo e($arsip->previousPageUrl()); ?>"
                class="flex items-center justify-center rounded-md border border-blue py-2 px-3 text-center text-xs transition-all shadow-sm hover:shadow-lg hover:text-white hover:bg-blue hover:border-blue <?php echo e($arsip->onFirstPage() ? 'opacity-50 cursor-not-allowed' : ''); ?>">
            ...
            <div class="flex space-x-2">
                <?php for($i = 1; $i <= $arsip->lastPage(); $i++): ?>
                    <a href="<?php echo e($arsip->url($i)); ?>"
                    ...
                    <?php echo e($arsip->currentPage() == $i ? 'bg-blue text-white' : 'border border-slate-300'); ?>">
                        <?php echo e($i); ?>
            ...
            <a href="<?php echo e($arsip->nextPageUrl()); ?>"
                ...
                <?php echo e($arsip->hasMorePages() ? '' : 'opacity-50 cursor-not-allowed'); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function resetForm() {
            ...
            window.location.href = '<?php echo e(auth()->user()->level_user == 'kades' ? '' : route('klasifikasi-arsip.index')); ?>';
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\klasifikasiArsip\index.blade.php ENDPATH**/ ?>