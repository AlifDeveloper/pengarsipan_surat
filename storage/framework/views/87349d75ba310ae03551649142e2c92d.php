...
<?php echo $__env->make('content.klasifikasiArsip.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->startSection('content'); ?>
    <div class="bg-transparent rounded-lg mb-4">
        <h2 class="text-[26px] text-gray-800 font-bold">Surat Keluar</h2>
        <p class="text-gray-500 text-sm"><span class='text-blue'>Beranda</span> / <span class='text-blue'>Pengarsipan</span> /
            Surat Keluar</p>
    </div>

    <!-- Search Section -->
    <form action="<?php echo e(auth()->user()->level_user == 'kades' ? route('pengarsipan-surat-keluar.index') : route('surat-keluar.index')); ?>" method="GET">
        <div class="bg-white p-6 rounded-lg shadow-md mt-4">
            <div class="flex items-center">
                ...
                <h3 class="font-bold  text-gray-800 text-md">Cari Surat Keluar</h3>
            </div>
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-4/12 mr-4">
                    ...
                    <select name="tahun" class="w-full text-sm bg-transparent border border-slate-200 rounded-md px-3 py-2 text-gray1">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-4">
        <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
            <div class="flex items-center space-x-2">
                ...
                <div>
                    <h3 class="text-md font-bold text-gray-800">Data arsip surat keluar</h3>
                    <p class="text-slate-500 text-sm">Berikut adalah data surat keluar yang tersedia.</p>
                </div>
            </div>
                ...
                <table class="min-w-full text-left table-auto  text-xs ">
                    <thead>
                        <tr>
                            ...
                            <th
                                class="<?php echo e(auth()->user()->level_user == 'kades' ? 'hidden': ''); ?> p-2 w-14 text-center transition-colors cursor-pointer border border-slate-300 bg-blue-50 hover:bg-slate-100">
                                <p class="flex items-center justify-between gap-2  font-medium leading-none ">
                                    Aksi
                                </p>
                            </th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $surat_keluar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50">
                                <td class="p-2 border border-slate-200 text-center">
                                    <p class="block  text-slate-800">
                                        <?php echo e(($surat_keluar->currentPage() - 1) * $surat_keluar->perPage() + $loop->iteration); ?>
                                ...
                                <td class="p-2 border border-slate-200">
                                    <p class="block  text-slate-800">
                                        <?php echo e($item->no_suratkeluar); ?> </p>
                                </td>
                                <td class="p-2 border border-slate-200">
                                    <p class="block  text-slate-800">
                                ...
                                <td class="p-2 border flex border-slate-200 <?php echo e(auth()->user()->level_user == 'kades' ? 'hidden' : ''); ?>">
                                    <p class="block  text-red1">
                                        <a data-modal-toggle = "delete-modal" data-id = "<?php echo e($item->no_suratkeluar); ?>"
                                            data-url = "<?php echo e(route('surat-keluar.destroy', $item->no_suratkeluar)); ?>"
                                    ...
                                    <p class="block  text-red1">
                                        <a href="<?php echo e(route('surat-keluar.edit', $item->no_suratkeluar)); ?>"
                                            class=" flex bg-transparent text-white px-1 py-1 rounded-lg cursor-pointer  text-xs">
        ...
        <div class="flex justify-between items-center mt-4 text-blue">
            <a href="<?php echo e($surat_keluar->previousPageUrl()); ?>"
                class="flex items-center justify-center rounded-md border border-blue py-2 px-3 text-center text-xs transition-all shadow-sm hover:shadow-lg hover:text-white hover:bg-blue hover:border-blue <?php echo e($surat_keluar->onFirstPage() ? 'opacity-50 cursor-not-allowed' : ''); ?>">
            ...
            <div class="flex space-x-2">
                <div class="flex space-x-2">
                    <?php for($i = 1; $i <= $surat_keluar->lastPage(); $i++): ?>
                        <a href="<?php echo e($surat_keluar->url($i)); ?>"
                        ...
                        <?php echo e($surat_keluar->currentPage() == $i ? 'bg-blue text-white' : 'border border-slate-300'); ?>">
                            <?php echo e($i); ?>
            ...
            <a href="<?php echo e($surat_keluar->nextPageUrl()); ?>"
                ...
                <?php echo e($surat_keluar->hasMorePages() ? '' : 'opacity-50 cursor-not-allowed'); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function resetForm() {
            ...
            window.location.href = '<?php echo e(auth()->user()->level_user == 'kades' ? route('pengarsipan-surat-keluar.index') : route('surat-keluar.index')); ?>';
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\suratKeluar\index.blade.php ENDPATH**/ ?>