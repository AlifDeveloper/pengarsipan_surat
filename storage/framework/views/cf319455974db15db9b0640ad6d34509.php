    ...
    <div class="min-h-screen flex relative font-poppins">
        ...
        <div class="hidden lg:flex lg:w-1/2  p-20 relative">
            ...
            <div class="absolute top-10 left-10 flex items-center space-x-4 z-10">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Kalurahan Karangrejek" class="w-16 h-16">
                <div>
...
<?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\auth\auth.blade.php ENDPATH**/ ?>