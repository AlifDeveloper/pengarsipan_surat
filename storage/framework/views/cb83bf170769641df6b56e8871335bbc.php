    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="flex">
            ...
            <div class="flex-1 relative flex flex-col rounded-xl bg-primary p-6 text-sm">
                ...
                <form method="POST" action="<?php echo e(auth()->user()->level_user == 'kades' ? route('profile-info.update', $user->nip) : route('profile.update', $user->nip)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-1 flex flex-col gap-6">
                        <div>
                            ...
                            <input type="text" name="username" value="<?php echo e(old('username', $user_info->username)); ?>"
                        ...
                        <div>
                            ...
                            <input type="password" name="password" value="<?php echo e(old('password', $user_info->password)); ?>"
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2" />
                        </div>

                        <div>
                            <label class="block mb-2 text-sm text-slate-600">NIP</label>
                            <input type="text" name="nip" value="<?php echo e(old('nip', $user->nip)); ?>"
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl_lahir" value="<?php echo e(old('tgl_lahir', $user->tgl_lahir)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="jabatan" value="<?php echo e(old('jabatan', $user->jabatan)); ?>"
                                class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2" />
                        </div>
            ...
            <div class="w-64 bg-white p-6 shadow-md ml-6 rounded-lg max-h-64">
                ...
                <div class="mt-4 flex flex-col items-center">
                    <img
                        id="profileImage"
                        src="<?php echo e(Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : asset('images/profile.png')); ?>"
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            document.getElementById('profileInput').addEventListener('change', function(event) {
                ...
                fetch("<?php echo e(auth()->user()->level_user == 'kades' ? route('profile.kades.upload') : route('profile.upload')); ?>", {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\profile\profile.blade.php ENDPATH**/ ?>