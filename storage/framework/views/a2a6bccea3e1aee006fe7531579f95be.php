        ...
        <div class="p-4">
            <div class="block overflow-visible">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <h3 class="text-md font-bold text-slate-800">Form Tambah Arsip Surat Keluar</h3>
                        <p class="text-slate-500 text-sm">Anda dapat menambah data surat keluar pada form dibawah ini.</p>
                    </div>
                </div>
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="<?php echo e(route('surat-keluar.store')); ?>" method="POST"
                            ...
                            <div class="flex">
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="no_suratkeluar"
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\suratKeluar\create.blade.php ENDPATH**/ ?>