            ...
            <div class="block overflow-visible">
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="<?php echo e(route('surat-masuk.update', $suratMasuk->no_suratmasuk)); ?>" method="POST"
                            ...
                            <select name="kode_arsip" id=""
                                ...
                                <?php $__currentLoopData = $klasifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->kode_arsip); ?>" <?php echo e($suratMasuk->kode_arsip == $item->kode_arsip ? 'selected' : ''); ?>>[<?php echo e($item->kode_arsip); ?>] <?php echo e($item->nama_arsip); ?></option>
                            ...
                            <div class="flex">
                                <div class="w-full md:w-6/12 mr-4">
                                    ...
                                    <input type="date" name="tgl_surat" value="<?php echo e($suratMasuk->tgl_surat); ?>"
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="no_suratmasuk" value="<?php echo e($suratMasuk->no_suratmasuk); ?>"
                            ...
                            <div class="flex">
                                <div class="w-full md:w-6/12 mr-4">
                                    ...
                                    <input type="text" name="perihal" value="<?php echo e($suratMasuk->perihal); ?>"
                                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-20 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="asal_surat" value="<?php echo e($suratMasuk->asal_surat); ?>"
                                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                            ...
                            <select name="nip" id=""
                                ...
                                <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->nip); ?>" <?php echo e($suratMasuk->nip == $item->nip ? 'selected' : ''); ?>><?php echo e($item->jabatan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            ...
                            <label class="flex items-center mt-4 ml-4">
                                <input type="checkbox" id="toggleDisposisi" name="disposisi" class="mr-2"
                                    <?php echo e(old('disposisi', $disposisi ? 'checked' : '')); ?>>
                                <span class="text-sm text-gray-600">Tambahkan ke Disposisi</span>
                            </label>

                            <div id="disposisiForm" class="<?php echo e(isset($disposisi) ? '' : 'hidden'); ?> mt-4">
                                
                                <label class="block mb-1 text-sm text-slate-600 mt-4">
                                    Tanggal Keluar Surat
                                </label>
                                <input type="date" name="tgl_surat_keluar" value="<?php echo e($disposisi->tgl_diterima ?? ''); ?>"
                                    class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                                    placeholder="DD/MM/YY" />
                                <input type="text" name="no_disposisi" value="<?php echo e($disposisi ? $disposisi->no_disposisi : ''); ?>" hidden id="">
                                ...
                                <div class="flex">
                                    <div class="w-full md:w-6/12 mr-4">
                                        ...
                                        <input type="text" name="diteruskan" value="<?php echo e($disposisi->tujuan_surat ?? ''); ?>"
                                            class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-20 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                                    ...
                                    <div class="w-full md:w-6/12">
                                        ...
                                        <select name="sifat" id=""
                                            ...
                                            <?php $__currentLoopData = $sifat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->kode_sifat); ?>"
                                                    <?php echo e(isset($disposisi) && $disposisi->kode_sifat == $item->kode_sifat ? 'selected' : ''); ?>>
                                                    <?php echo e($item->nama_sifat); ?>
                            ...
                            <?php if($suratMasuk->lampiran): ?>
                            <div class="mt-4">
                                <p class="text-sm text-gray-600 font-semibold">Lampiran saat ini:</p>
                                <div class="mt-2 flex items-center">
                                    <img src="<?php echo e(asset('storage/' . $suratMasuk->lampiran)); ?>" alt="Current attachment" class="w-24 h-24 object-cover rounded-md">
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0. joki\Refa\Revisi\pengarsipan_surat\resources\views\content\pengarsipan\suratMasuk\edit.blade.php ENDPATH**/ ?>