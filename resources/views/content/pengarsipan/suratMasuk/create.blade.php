            ...
            <div class="block overflow-visible">
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="{{ route('surat-masuk.store') }}" method="POST"
                            ...
                            <select name="kode_arsip" id=""
                                ...
                                @foreach ($klasifikasi as $item)
                                    <option value="{{ $item->kode_arsip }}">[{{ $item->kode_arsip }}] {{ $item->nama_arsip }}</option>
                                @endforeach
                            </select>
                                    ...
                                    <div class="w-full md:w-6/12">
                                        ...
                                        <select name="sifat" id=""
                                            ...
                                            @foreach ($sifat as $item)
                                                <option value="{{ $item->kode_sifat }}">{{ $item->nama_sifat }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
