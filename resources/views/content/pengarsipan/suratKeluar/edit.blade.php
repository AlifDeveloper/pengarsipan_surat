            ...
            <div class="block overflow-visible">
                ...
                <div class="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                    <div role="tabpanel" data-value="card">
                        <form class="mt-2 flex flex-col" action="{{ route('surat-keluar.update', $suratKeluar->no_suratkeluar) }}" method="POST"
                            ...
                            <select name="kode_arsip" id=""
                                ...
                                @foreach ($klasifikasi as $item)
                                    <option value="{{ $item->kode_arsip }}" {{ $suratKeluar->kode_arsip == $item->kode_arsip ? 'selected' : '' }}>[{{ $item->kode_arsip }}] {{ $item->nama_arsip }}</option>
                                @endforeach
                            </select>
                            ...
                            <div class="flex">
                                <div class="w-full md:w-6/12 mr-4">
                                    ...
                                    <input type="date" name="tgl_surat" value="{{ $suratKeluar->tgl_surat }}"
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="no_suratkeluar" value="{{ $suratKeluar->no_suratkeluar }}"
                            ...
                            <div class="flex">
                                ...
                                <div class="w-full md:w-6/12">
                                    ...
                                    <input type="text" name="tujuan" value="{{ $suratKeluar->tujuan }}"
                                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                            ...
                            <select name="nip" id=""
                                ...
                                @foreach ($petugas as $item)
                                    <option value="{{ $item->nip }}" {{ $suratKeluar->nip == $item->nip ? 'selected' : '' }}>{{ $item->jabatan }}</option>
                                @endforeach
                            </select>
